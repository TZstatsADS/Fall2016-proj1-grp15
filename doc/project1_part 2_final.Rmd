...
## Part 2. Influences of STEM policy to graduated students
...
Before we start to analyze data, we should clean and preprocess data. Following R codes include the specific cleaning and preprocessing procedures.
```{r}
library(data.table)
library(dplyr)
